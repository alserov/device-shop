...
func NewRepo(db *sql.DB) db.AdminRepo {
	return &repo{
		db: db,
	}
}
...
func (r *repo) CreateDevice(_ context.Context, device db.Device) error {
...
func (r *repo) UpdateDevice(_ context.Context, device db.UpdateDevice) error {
