...
type Device struct {
	...
	Price        float32 `json:"price,omitempty" bson:"price" validate:"required,gt=0.0~Price can't be less or equal than 0'"`
...
type GetAllDevicesReq struct {
	Index  int32 `json:"index,omitempty" validate:"required,gt=0"`
