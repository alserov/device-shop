...
func (err *RequestError) Handle(ctx context.Context, order *CreateOrderReqWithDevices, deviceAddr string, userAddr string) error {
	...
	case 1:
		...
		return err.Err
	case 2:
		price := utils.CountOrderPrice(order.Devices)
