...
type CreateOrderReq struct {
	...
	DevicesUUIDs []string `protobuf:"bytes,2,rep,name=DevicesUUIDs,proto3" json:"DevicesUUIDs,omitempty"`
}
...
func (x *CreateOrderReq) GetDevicesUUIDs() []string {
	if x != nil {
		return x.DevicesUUIDs
	}
	return nil
}
...
var file_proto_order_proto_rawDesc = []byte{
	...
	0x2f, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x50, 0x0a, 0x0e,
	...
	0x52, 0x08, 0x55, 0x73, 0x65, 0x72, 0x55, 0x55, 0x49, 0x44, 0x12, 0x22, 0x0a, 0x0c, 0x44, 0x65,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x55, 0x55, 0x49, 0x44, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x0c, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x55, 0x55, 0x49, 0x44, 0x73, 0x22, 0x2e,
	...
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x55, 0x55, 0x49, 0x44, 0x32, 0xbd, 0x01, 0x0a, 0x06, 0x4f, 0x72,
	...
	0x65, 0x63, 0x6b, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x12, 0x3c, 0x0a, 0x0b, 0x55,
	...
	0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x03, 0x5a, 0x01, 0x2f, 0x62, 0x06,
...
var file_proto_order_proto_depIdxs = []int32{
	5, // 0: order.CheckOrderRes.CreatedAt:type_name -> google.protobuf.Timestamp
	6, // 1: order.CheckOrderRes.Devices:type_name -> device.Device
	0, // 2: order.Orders.CreateOrder:input_type -> order.CreateOrderReq
	2, // 3: order.Orders.CheckOrder:input_type -> order.CheckOrderReq
	4, // 4: order.Orders.UpdateOrder:input_type -> order.UpdateOrderReq
	1, // 5: order.Orders.CreateOrder:output_type -> order.CreateOrderRes
	3, // 6: order.Orders.CheckOrder:output_type -> order.CheckOrderRes
	7, // 7: order.Orders.UpdateOrder:output_type -> google.protobuf.Empty
